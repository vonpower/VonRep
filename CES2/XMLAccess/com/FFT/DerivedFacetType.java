...
public class DerivedFacetType extends com.altova.xml.Node {

	public DerivedFacetType(DerivedFacetType node) {
		super(node);
	}

	public DerivedFacetType(org.w3c.dom.Node node) {
		super(node);
	}

	public DerivedFacetType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public DerivedFacetType(com.altova.xml.Document doc, String namespaceURI, String prefix, String name) {
