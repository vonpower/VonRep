                ...
                <xsl:for-each select="n1:FFTable">
                    ...
                    <div style="border-bottom-color:#000080; border-bottom-style:solid; border-bottom-width:medium; ">
                        <xsl:for-each select="@Name">
                            <span style="background-color:transparent; color:#FF8000; font-family:仿宋_GB2312; font-size:larger; font-weight:bold; ">
                                <xsl:value-of select="." />
                            </span>
                            <span style="background-color:transparent; color:#FF8000; font-family:仿宋_GB2312; font-size:larger; font-weight:bold; ">因素因子权重值赋值表</span>
                        </xsl:for-each>
                        <br />
