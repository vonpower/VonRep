...
import ynugis.ui.confDialog.SelectionClauseDialog;
...
public class ProDialogTest extends ApplicationWindow {
...
//	private IWorkspaceEdit edit;
	...
	public ProDialogTest(Shell parent,MapControl mc,ILayer layer) {
		super(parent);
...
//			gd.minimumWidth=70;
		...
		tv=new TableViewer(tableCom,SWT.MULTI|SWT.BORDER|SWT.FULL_SELECTION);
		{
